...
heading = Label(frame,text="تسجيل الدخول",fg="black",bg="#ECF9FF",font=('Microsoft YaHei UI Light ',25,'bold'))
...
def on_button_click():
    doctor.func()
    #print('here')
btn_login = Button(frame,width=39,pady=7,text="تسجيل الدخول",bg="#57a1f8",fg='white',border=0, command=on_button_click)
...
label = Label(frame,text="Log in as admin",fg='red',bg="#ECF9FF",font=('Microsoft YaHei UI Light ',10))
